...
public class Waiters {
    ...
    public static Boolean waitUntilElementIsVisibletru(WebDriver driver, By selector) {
        return new WebDriverWait(driver, Duration.ofSeconds(TIME_OUT))
                .until(ExpectedConditions.textToBePresentInElement(driver.findElement(selector), "Invalid username or password!"));
    }
